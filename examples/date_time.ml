let () =
  ...
  let ordinary_dt =
    ...
    Timere.Date_time.make_exn ~tz ~year:2021 ~month:5 ~day:1 ~hour:13 ~minute:0 ~second:0 ()
  in
  ...
  let ambiguous_dt =
    ...
    Timere.Date_time.make_exn ~tz ~year:2021 ~month:4 ~day:4 ~hour:2 ~minute:30 ~second:0 ()
  in
  ...
  let non_existent_dt =
    ...
    Timere.Date_time.make ~tz ~year:2021 ~month:10 ~day:3 ~hour:2 ~minute:30 ~second:0 ()
  in
