...
(** {1 Tutorial}
    ...
    ambiguity is made explicit as return type via {!local_date_time_result}.
    ...
    If such a coercion is desirable, however, then you can use either {!min_of_local_date_time_result} or
    {!max_of_local_date_time_result}.
...
v}
    ...
    Timedesc uses {!local_date_time_result} variant type, of which [`Single _] indicates lack of ambiguity for the particular result,
    ...
    they may use {!min_of_local_date_time_result} or {!max_of_local_date_time_result}.
...
(** This is the main type, and represents a point in the local timeline
    ...
    In the ambiguous case, functions which return [_ local_date_time_result] will yield an [`Ambiguous _]
